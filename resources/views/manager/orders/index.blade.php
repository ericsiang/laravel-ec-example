...
<div class="x_panel"> 
  <div class="col-md-12 col-sm-12 col-xs-12">
      <form action='/manager/orders/search' method='POST'>
        @csrf
      <!--<div class="col-md-2">
      ...
      <div class="col-md-3 row">
          <div class="input-group">
              <input type="text" class="form-control" placeholder="請輸入訂單號碼" id="search" name="search"
                  value="{{  $input['search'] ?? '' }}">
              <span class="input-group-btn">
                  <button type="submit" class="btn btn-effect-ripple btn-primary">搜尋</button>
                  <button type="button" class="btn btn-effect-ripple btn-primary"><a href='/manager/orders' style='color:#FFF;'>清除</a></button>
              </span>
          </div>
      </div>
                        ...
                        <thead>
                            <tr class="headings">
                               <!-- <th>
                                ...
                                <th class="column-title">會員信箱</th>
                                <th class="column-title">訂單狀態</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($orderLists as $order)
                                <tr class="even pointer">
                                    ...
                                    <td class=" last">
                                            <button class="btn btn-success"><a href='/manager/orders/{{ $order->order_id }}' style='color:#fff;'>編輯<a></button>
                                    </td>
                                </tr>
                            @endforeach
