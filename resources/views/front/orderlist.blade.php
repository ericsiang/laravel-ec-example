            ...
            <table class="shop_table cart table">
                <thead>
                    <tr>
                        ...
                        <th class="product-subtotal" >Order Detial</th>
                    </tr>
                </thead>
                <tbody>
                    @php
                    ...
                    @foreach ($orders as $order)
                        <tr class="cart_item">
                            <td class="product-name">
                                <span class="amount">{{ $order->order_no }}</span>
                            </td>
                            <td class="product-price">
                                <span class="amount">{{ $order->order_total }}</span>
                            </td>
                            ...
                            <td class="product-subtotal">
                                <a target="_blank" href="/orderdetial/{{ $order->order_id }}"><span class="amount">查看</span></a>
                            </td>
                        </tr>
                    @endforeach
                    <!--
